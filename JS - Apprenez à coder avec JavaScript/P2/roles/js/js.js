...
Joueur.decrire = function () {
    ...
    this.force + " en force, " + this.xp + " points d'expérience, " + this.piece + " pièces d'or et " + this.cle + " clé(s)";
    return description;
};
...
Joueur.combattre = function (adversaire) {
    ...
    if (adversaire.sante === 0) {
        ...
        console.log(this.nom + " a tué " + adversaire.nom + " et gagne " +
            adversaire.valeur + " points d'expérience, ainsi que " + piecesGagnees + " pièces d'or et " + cleGagnee + " clé(s)");
            this.xp += adversaire.valeur;
            this.piece += piecesGagnees;
            this.cle += cleGagnee;
    }
};
